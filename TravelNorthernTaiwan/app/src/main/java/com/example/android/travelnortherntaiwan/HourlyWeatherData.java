...
public class HourlyWeatherData extends AppCompatActivity {
    ...
    private com.example.android.travelnortherntaiwan.HourlyDataAdapter hourlyAdapter;
    ...
    private void updateGUI() {
        if(weatherData != null) {
            ...
            hourlyAdapter = new com.example.android.travelnortherntaiwan.HourlyDataAdapter(weatherData.getHourly().getData());
