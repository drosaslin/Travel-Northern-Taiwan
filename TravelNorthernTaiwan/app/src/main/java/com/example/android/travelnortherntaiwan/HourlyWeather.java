...
class HourlyWeather implements Parcelable {
    ...
    private String icon;
    private ArrayList<com.example.android.travelnortherntaiwan.Forecast> data;
    ...
    protected HourlyWeather(Parcel in) {
        ...
        icon = in.readString();
        data = in.createTypedArrayList(com.example.android.travelnortherntaiwan.Forecast.CREATOR);
    }
